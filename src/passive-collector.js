...
// Keep startup bounded on the PostgreSQL catalog; older resources are still
// deduplicated by the database when they are observed again.
const RECENT_RESOURCE_TTL_MS = 2 * 60 * 60 * 1000
